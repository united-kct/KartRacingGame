...
namespace Generated.MasterData
{
   ...
   {
        public FrictionTable FrictionTable { get; private set; }

        public MemoryDatabase(
            FrictionTable FrictionTable
        )
        {
            this.FrictionTable = FrictionTable;
        }
        ...
        {
            this.FrictionTable = ExtractTableData<Friction, FrictionTable>(header, databaseBinary, options, xs => new FrictionTable(xs));
        }
        ...
        public DatabaseBuilder ToDatabaseBuilder()
        {
            ...
            builder.Append(this.FrictionTable.GetRawDataUnsafe());
            return builder;
        }
        ...
        public ValidateResult Validate()
        {
            ...
            ((ITableUniqueValidate)FrictionTable).ValidateUnique(result);
            ValidateTable(FrictionTable.All, database, "Id", FrictionTable.PrimaryKeySelector, result);
